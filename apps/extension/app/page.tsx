  ...
  return (
    <main className="focus-on-shell">
      ...
      <section className="study-card" aria-labelledby="study-title">
        ...
        <p className="muted-text">페이지 이동과 체류 흐름을 기록해서 집중 습관을 확인할 수 있어.</p>
      ...
      <section className="summary-grid" aria-label="FocusOn 브라우저 상태">
        <article className="summary-item"><span className="summary-label">현재 페이지</span><strong>확인 대기 중</strong></article>
        <article className="summary-item"><span className="summary-label">학습 목표</span><strong>설정되지 않음</strong></article>
        <article className="summary-item"><span className="summary-label">분석 상태</span><strong>{isStudying ? '진행 중' : '대기 중'}</strong></article>
      </section>
    </main>
  )
}
